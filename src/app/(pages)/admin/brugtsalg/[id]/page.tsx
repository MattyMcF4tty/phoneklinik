...
import InternalNotesField from '@/app/(pages)/admin/brugtsalg/[id]/components/InternalNotesField';
import ValuationField from '@/app/(pages)/admin/brugtsalg/[id]/components/ValuationField';
